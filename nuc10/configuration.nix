...

{
  ...
  boot.initrd.luks.devices."luks-3c7432fe-2f6c-484c-95ee-67da8afaf55b" = {
    device = "/dev/disk/by-uuid/3c7432fe-2f6c-484c-95ee-67da8afaf55b";
  ...
  networking.hostName = "nuc10"; # Define your hostname.
